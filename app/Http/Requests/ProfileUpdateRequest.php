...
class ProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_work_assignment' => [
                'nullable', // Tambahkan ini agar tidak kena cek required
                function ($attribute, $value, $fail) {
                    // Jika kosong atau string 'none', abaikan validasi database (lolos)
                    if (empty($value) || $value === 'none') {
                        return;
                    }

                    // Jika diisi angka/ID, cek keberadaannya di database
                    if (!\DB::table('work_assignments')->where('id_work_assignment', $value)->exists()) {
    ...
    public function messages(): array
    {
        return [
            ...
            'latitude_gps_domicile.required' => 'Koordinat Latitude wajib diisi.',
            'longitude_gps_domicile.required' => 'Koordinat Longitude wajib diisi.',
