        ...
        <div class="relative bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-6xl overflow-hidden transform transition-all font-sans text-[13px]">
            ...
            <div class="p-6 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="font-bold uppercase tracking-widest text-slate-700">Export Data Penerima Manfaat</h3>
                </div>
            ...
            <form action="{{ route('admin.manage-beneficiary.export') }}" method="POST" id="formExportExcel">
                @csrf
