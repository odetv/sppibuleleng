{{-- MODAL DELETE --}}
<div id="deleteModal" class="fixed inset-0 z-99 hidden items-center justify-center p-4 text-left">
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl max-w-sm w-full p-8 text-center border border-slate-100">
        ...
        <h3 class="text-lg font-bold text-slate-800 uppercase tracking-widest mb-2" id="delete_modal_title">Hapus Petugas?</h3>
        ...
        <div class="flex gap-3">
            ...
            <form id="deleteForm" method="POST" class="flex-1">
                @csrf @method('DELETE')
                <button type="submit" id="delete_btn_text" class="w-full py-3 text-[11px] font-bold uppercase tracking-wider text-white bg-rose-600 rounded-xl shadow-lg hover:bg-rose-700 transition-colors font-sans">Hapus Sekarang</button>
            </form>
        </div>
    </div>
</div>
