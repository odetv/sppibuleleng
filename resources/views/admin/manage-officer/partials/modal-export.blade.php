        ...
        <div class="relative bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-6xl overflow-hidden transform transition-all font-sans text-[13px]">
            ...
            <div class="p-6 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="font-bold uppercase tracking-widest text-slate-700">Export Data Petugas</h3>
                </div>
            ...
            <form action="{{ route('admin.manage-officer.export') }}" method="POST" id="formExportExcel">
                @csrf
                <div class="p-8 max-h-[70vh] overflow-y-auto scrollbar-thin">
                        ...
                        <div>
                            <div class="flex justify-between items-center border-b border-slate-200 pb-2 mb-4">
                                ...
                                <div class="flex gap-3">
                                    <button type="button" @click="toggleCategoryCheckboxes({{ $catIndex }}, true)" class="text-[10px] font-semibold text-indigo-600 hover:underline uppercase">Pilih Semua</button>
                                    <button type="button" @click="toggleCategoryCheckboxes({{ $catIndex }}, false)" class="text-[10px] font-semibold text-rose-600 hover:underline uppercase">Hapus Semua</button>
                                </div>
                            </div>
                    ...
                    <div id="no-column-warning" class="mt-6 p-3 bg-rose-50 text-rose-600 rounded-lg border border-rose-100 hidden items-center gap-2">
