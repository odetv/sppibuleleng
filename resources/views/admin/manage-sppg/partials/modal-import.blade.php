            ...
            <div class="p-8">
                ...
                <div id="import-step-1" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between p-4 bg-indigo-50 border border-indigo-100 rounded-xl">
                        ...
                        <a href="{{ route('admin.manage-sppg.template') }}" class="px-4 py-2 bg-indigo-600 text-white text-[10px] font-bold rounded-lg uppercase shadow-md hover:bg-indigo-700 transition-all">Unduh Template</a>
                    </div>
                ...
                <div id="import-step-2" class="hidden space-y-6">
                    ...
                    <form action="{{ route('admin.manage-sppg.import') }}" method="POST" id="final-import-form">
                        @csrf
                        ...
                        <div id="import_user_progress" class="hidden py-6 flex flex-col justify-center items-center space-y-4">
                            ...
                            <p id="import_progress_desc" class="text-[10px] text-slate-400 font-medium text-center italic mt-2">Menyimpan data SPPG ke dalam sistem. Mohon bersabar.</p>
