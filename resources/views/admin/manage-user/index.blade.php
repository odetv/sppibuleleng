                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        <span class="text-xs text-slate-500 font-medium capitalize">
                                            {{ $user->person?->workAssignment?->sppgUnit?->name ?? $user->person?->sppgOfficer?->sppgUnit?->name ?? '-' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors {{ !$person ? 'bg-slate-50/50 opacity-60' : '' }}">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        <span class="text-xs text-slate-500 font-medium capitalize">
                                            {{ $person?->workAssignment?->sppgUnit?->name ?? $person?->sppgOfficer?->sppgUnit?->name ?? '-' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                ...
                                <tr class="hover:bg-rose-50/30 transition-colors opacity-80 text-[12px]">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        <span class="text-xs text-slate-500 capitalize font-medium">
                                            {{ $personTrashed?->workAssignment?->sppgUnit?->name ?? $personTrashed?->sppgOfficer?->sppgUnit?->name ?? '-' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
