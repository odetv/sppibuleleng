...
<head>
    ...
    <title>SPPI Buleleng | Lupa Kata Sandi</title>
        ...
        <div class="flex flex-col md:flex-row w-full max-w-5xl rounded-2xl overflow-hidden shadow-2xl border border-gray-100 bg-white md:max-h-[90vh]">
            ...
            <div class="w-full md:w-1/2 bg-white p-8 md:p-12 flex flex-col justify-center">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" class="w-full bg-darkblue text-white py-3 rounded-lg font-bold flex items-center justify-center gap-2 hover:bg-[#1a3d7a] active:scale-[0.98] transition-all shadow-lg shadow-blue-900/20">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
