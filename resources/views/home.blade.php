...
<html>
    ...
    <body>
        <div class="bg-white">
            ...
            <div class="relative isolate px-6 pt-14 lg:px-8 mx-auto max-w-7xl">
                ...
                <div class="py-32 sm:py-48 lg:py-56">
                    <div class="mb-8 sm:flex justify-center">
                        <div class="relative rounded-full px-4 py-2 text-xs sm:text-sm text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                        <p class="text-center">Sarjana Penggerak Pembangunan Indonesia untuk Badan Gizi Nasional</p>
                    </div>
                </div>
                <div class="text-center">
                    ...
                    <p class="mt-8 text-sm font-medium text-gray-500 sm:text-lg">SPPI untuk BGN merujuk pada program Sarjana Penggerak Pembangunan Indonesia, yang merekrut lulusan sarjana untuk menjadi ASN di Badan Gizi Nasional. Program ini bertujuan untuk memastikan setiap anak memiliki akses gizi yang layak dan menggarap aspek teknis, serta melibatkan peserta dalam pelatihan kepemimpinan dan dasar militer untuk penguatan ketahanan nasional.</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#" class="rounded-md bg-blue-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-blue-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Jelajahi</a>
                    <a href="#" class="text-sm/6 font-semibold text-gray-900">Selengkapnya <span aria-hidden="true">→</span></a>
                    </div>
                </div>
                </div>
            </div>
