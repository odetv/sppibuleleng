...
<body class="bg-white mx-auto max-w-11/12">
    ...
    <section id="overview" class="pt-16 max-w-7xl mx-auto">
    ...
    <section id="info-quick-update-sppg" class="pt-16 pb-16 sm:pt-26 sm:pb-26">
        ...
        <div class="mx-auto max-w-11/12 px-6 lg:px-8">
            <dl class="flex sm:flex-row justify-center items-center text-center gap-4 flex-wrap">
